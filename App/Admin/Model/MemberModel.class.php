...
class MemberModel extends BaseModel {
	...
	protected $_validate = array(
		...
		/* 验证用户名 */
		array('username', '4,30', '用户名长度不合法', self::EXISTS_VALIDATE, 'length'), //
		array('username', 'checkDenyMember', '用户名禁止注册', self::EXISTS_VALIDATE, 'callback'), //
		array('username', '', '用户名被占用', self::EXISTS_VALIDATE, 'unique', 3), //
		/* 验证密码 */
		...
		array('email', 'checkDenyEmail', '邮箱禁止注册', self::EXISTS_VALIDATE, 'callback'), //
		array('email', '', '邮箱被占用', self::EXISTS_VALIDATE, 'unique', 1), //
		/* 验证手机号码 */
		array('mobile', '//', '手机格式不正确', self::EXISTS_VALIDATE), // TODO:
		array('mobile', 'checkDenyMobile', '手机禁止注册', self::EXISTS_VALIDATE, 'callback'), //
