...
include_once $_SERVER ['DOCUMENT_ROOT'] . '/zhifusdk/utf8/func/SDKConfig.php';
include_once $_SERVER ['DOCUMENT_ROOT'] . '/zhifusdk/utf8/func/secureUtil.php';
include_once $_SERVER ['DOCUMENT_ROOT'] . '/zhifusdk/utf8/func/httpClient.php';
...
$params = array(
		...
		'merId' =>MEMBER_ID,			//商户代码，请改成自己的测试商户号
